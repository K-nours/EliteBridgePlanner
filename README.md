...
- **Endpoints** : `GET /api/dashboard/commanders?guildId=1` (lecture cache) | `POST /api/sync/inara/commanders?guildId=1` (sync) | `GET /api/sync/inara/roster-diagnostic?guildId=1` (diagnostic)
