...
namespace EliteBridgePlanner.Server.Migrations
{
    ...
    [Migration("20260305094831_LinkedListRefactor")]
    partial class LinkedListRefactor
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EliteBridgePlanner.Server.Models.StarSystem", b =>
                {
                    ...
                    b.HasIndex("PreviousSystemId")
                        .IsUnique()
                        .HasFilter("[PreviousSystemId] IS NOT NULL");
            ...
            modelBuilder.Entity("EliteBridgePlanner.Server.Models.StarSystem", b =>
                {
                    ...
                    b.HasOne("EliteBridgePlanner.Server.Models.StarSystem", "PreviousSystem")
                        .WithOne("NextSystem")
                        .HasForeignKey("EliteBridgePlanner.Server.Models.StarSystem", "PreviousSystemId")
