...
const COMMODITY_EQUIVALENCE_GROUPS: readonly (readonly string[])[] = [
  ...
  ['terrainenrichmentsystems', 'Terrain Enrichment Systems', 'sys. enrichissement terrain',
   "systèmes d'enrichissement du terrain"],
...
const COMMODITY_LABELS: Readonly<Record<string, { fr: string; en: string }>> = {
  ...
  terrainenrichmentsystems:  { fr: 'Sys. enrichissement terrain',      en: 'Terrain Enrichment Systems' },
